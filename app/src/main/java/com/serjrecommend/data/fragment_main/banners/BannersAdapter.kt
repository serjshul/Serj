...
class BannersAdapter(private val data: ArrayList<BannersModel>): RecyclerView.Adapter<BannersAdapter.ViewHolder>() {
    ...
    interface OnClickListener {
        fun onClick(position: Int, model: BannersModel)
    }
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.text.text = itemData.text
